...
- `project_name`: the default docker compose project name (default: `config_extension`)
...
Using **Invoke** these configuration options can be overridden using [several methods](https://docs.pyinvoke.org/en/stable/concepts/configuration.html). Perhaps the simplest is setting an environment variable `INVOKE_CONFIG_EXTENSION_VARIABLE_NAME` where `VARIABLE_NAME` is the variable you are trying to override. The only exception is `compose_files`, because it is a list it must be overridden in a YAML file. There is an example `invoke.yml` (`invoke.example.yml`) in this directory which can be used as a starting point.
...
#14 naming to docker.io/config-extension/nautobot:latest-py3.7 done
```
...
Creating network "config_extension_default" with the default driver
Creating volume "config_extension_postgres_data" with default driver
Creating config_extension_redis_1 ...
Creating config_extension_docs_1  ...
Creating config_extension_postgres_1 ...
Creating config_extension_postgres_1 ... done
Creating config_extension_redis_1    ... done
Creating config_extension_nautobot_1 ...
Creating config_extension_docs_1     ... done
Creating config_extension_nautobot_1 ... done
Creating config_extension_worker_1   ...
Creating config_extension_worker_1   ... done
...
ee90fbfabd77   config-extension/nautobot:latest-py3.7   "nautobot-server rqw…"   16 seconds ago   Up 13 seconds                                               config_extension_worker_1
b8adb781d013   config-extension/nautobot:latest-py3.7   "/docker-entrypoint.…"   20 seconds ago   Up 15 seconds   0.0.0.0:8080->8080/tcp, :::8080->8080/tcp   config_extension_nautobot_1
d64ebd60675d   config-extension/nautobot:latest-py3.7   "mkdocs serve -v -a …"   25 seconds ago   Up 18 seconds   0.0.0.0:8001->8080/tcp, :::8001->8080/tcp   config_extension_docs_1
e72d63129b36   postgres:13-alpine               "docker-entrypoint.s…"   25 seconds ago   Up 19 seconds   0.0.0.0:5432->5432/tcp, :::5432->5432/tcp   config_extension_postgres_1
96c6ff66997c   redis:6-alpine                   "docker-entrypoint.s…"   25 seconds ago   Up 21 seconds   0.0.0.0:6379->6379/tcp, :::6379->6379/tcp   config_extension_redis_1
```
...
Stopping config_extension_worker_1   ...
Stopping config_extension_nautobot_1 ...
Stopping config_extension_docs_1     ...
Stopping config_extension_redis_1    ...
Stopping config_extension_postgres_1 ...
Stopping config_extension_worker_1   ... done
Stopping config_extension_nautobot_1 ... done
Stopping config_extension_postgres_1 ... done
Stopping config_extension_redis_1    ... done
Stopping config_extension_docs_1     ... done
Removing config_extension_worker_1   ...
Removing config_extension_nautobot_1 ...
Removing config_extension_docs_1     ...
Removing config_extension_redis_1    ...
Removing config_extension_postgres_1 ...
Removing config_extension_postgres_1 ... done
Removing config_extension_docs_1     ... done
Removing config_extension_worker_1   ... done
Removing config_extension_redis_1    ... done
Removing config_extension_nautobot_1 ... done
Removing network config_extension_default
```
...
So for example, our plugin is named `config-extension`, the command would most likely be `docker logs config_extension_nautobot_1 -f`. You can find the name of all running containers via `docker ps`.
...
Or set the `INVOKE_CONFIG_EXTENSION_NAUTOBOT_VER` variable.
